    ...
    items: [
      {
        ...
        bullets: [
          'Building Aurora, an internal GenAI product used by 50,000+ employees globally to automate admin workflows such as meeting management, room booking, and timesheets.',
          'Designing backend services, agent workflows, tool orchestration, and Slack-based product experiences for enterprise-scale use cases.',
          'Integrated 20+ internal and external tools/APIs to support agent-driven workflows across production systems.',
          ...
          'Collaborating with engineering teams across the US and Europe to ship reliable, production-grade systems.',
        ],
      },
      {
